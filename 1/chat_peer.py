...
class ChatScreen(tk.Canvas, threading.Thread):
    def __init__(self, parent, first_frame, client_socket, clients_connected, user_id):
        ...
        tk.Label(self, text="AHKILESS", font="lucida 15 bold", padx=20, fg="green",
       ...
       # ****************************Menu ******************************
        ...
        menubar.add_command(label="Video Call", command=self.videocall)
        menubar.add_command(label="Audio Call", command=self.videocall)
        menubar.add_command(label="Facial Recognition", command=self.videocall)
